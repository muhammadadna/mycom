            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-6 bg-white">
                <div class="d-flex align-items-center px-4 px-lg-5 h-100 bg-dash-dark-2">
                  <form class="register-form py-5 w-100" action="{{ route('register.action') }}" method="POST">
                    @csrf
                    <div class="input-material-group mb-3">
                        <input class="input-material" type="text" name="name" value="{{ old('name') }}" />
                        <label class="label-material" for="register-username">Name</label>
                    </div>
                    <div class="input-material-group mb-3">
                        <input class="input-material" type="username" name="username" value="{{ old('username') }}" />
                        <label class="label-material" for="register-username">Username</label>
                    </div>
                    <div class="input-material-group mb-3">
                        <input class="input-material" type="email" name="email" value="{{ old('email') }}" />
                        <label class="label-material" for="register-username">Email</label>
                    </div>
                    <div class="input-material-group mb-3">
                        <input class="input-material" type="password" name="password" />
                        <label class="label-material" for="register-username">Password</label>
                    </div>
                    <div class="input-material-group mb-3">
                        <input class="input-material" type="password" name="password_confirm" />
                        <label class="label-material" for="register-username">Password Confirmation</label>
                    </div>
                    <button class="btn btn-primary mb-3">Register</button>
                    <br>
                    <small class="text-gray-500">Already have an account?</small>
